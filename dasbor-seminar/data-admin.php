                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Data Administrator</li>
                                        </ul>
                                    </div>
                                    <a class="au-btn au-btn-icon au-btn--green" href="tambah-admin/">
                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
											...
											<tr>
												...
												<td><font face="trebuchet MS"><?php echo $data["username"];?></font></td>
                                                <td><font face="trebuchet MS"><?php echo $data["wkt_dftr"];?></font></td>
                                                <td><font face="trebuchet MS"><?php echo $data["ha"];?></font></td>
                                                <td> 
              
     
      <a href="edit-admin/index.php?id_user=<?php echo $data['id_user']; ?>&aksi=edit" type="button" class="btn btn-success"><i class="fa fa-edit"></i></a>
      <a href="edit-admin/proses.php?id_user=<?php echo $data['id_user']; ?>&aksi=hapus" type="button" class="btn btn-danger"><i class="fa fa-trash"></i></a>
