        ...
        <div class="page-container2">
            ...
            <!-- END BREADCRUMB-->
						<div class="row m-t-30">
                            ...
                            <br/>
					        <h1>Halo <?=$_SESSION['nama'];?>, Selamat datang di dasbor Admin!</h1><br/>
                            <h2>Silahkan gunakan dengan bijak.</h2><br/><br/>
                            <h3>Anda masuk sebagai: <b><?=$_SESSION['ha'];?></b></h3><br/>
                            <h4><small>Anda terdaftar pada <b><?=$_SESSION['wkt_dftr'];?>.</b></small></h4>
                            </center>
							</div>
                        </div>
                        <div class="row m-t-30">
                            <div class="col-md-12">
                            <center>
					        <a class="btn btn-primary" href="tambah-admin/">Tambah Administrator</a> <a class="btn btn-success" href="appver.php">Detail Aplikasi</a><br/><br/>
                            </center>
							</div>
                        </div>
                        </div>
